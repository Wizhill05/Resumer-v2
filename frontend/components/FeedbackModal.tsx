          ...
          <div className="space-y-6">
                ...
                return (
                  ...
                  >
                    <Star
                      ...
                      className={
                        active
                          ? "fill-[#ff4e26] text-[#ff4e26] drop-shadow-[2px_2px_0px_#000]"
            ...
            <div className="flex gap-2">
              ...
              <Button
                ...
                className="flex-1 bg-[#ff4e26] hover:bg-[#e03d16] text-white font-extrabold uppercase text-xs border-2 border-black shadow-[3px_3px_0px_#000000] disabled:opacity-50"
              >
